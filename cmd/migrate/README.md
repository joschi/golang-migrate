...
$ # Go 1.16+
$ go install -tags 'postgres' github.com/golang-migrate/migrate/cmd/migrate/v5@$TAG
```
...
$ # Go 1.16+
$ go install -tags 'postgres' github.com/golang-migrate/migrate/cmd/migrate/v5@latest
```
