...
$ # Go 1.16+
$ go install -tags 'postgres' github.com/golang-migrate/migrate/v5/cmd/migrate@$TAG
```
...
$ # Go 1.16+
$ go install -tags 'postgres' github.com/golang-migrate/migrate/v5/cmd/migrate@latest
```
